(function () {
  ...
  // ---------------------------------------------------------------
  var PUBS = [
    { year: 2026, type: "workshop", authors: "Blümel, L., Sauerwald, K., Skiba, K., & Thimm, M.", title: "On the Complexity of the Discussion-based Semantics in Abstraction Argumentation", venue: "24th International Workshop on Nonmonotonic Reasoning", pdf: null, bibtex: "@article{BluemelSST2026,\n  author  = {Bl\\\"umel, Lydia and Sauerwald, Kai and Skiba, Kenneth and Thimm, Matthias},\n  title   = {On the Complexity of the Discussion-based Semantics in Abstract Argumentation},\n  journal = {arXiv preprint arXiv:2604.11480},\n  year    = {2026}\n}", abstract: null },
